...
class Rifas extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'date_init', 'status', 'ticket_init', 'ticket_end','phone','banner','time_apart','state'], 'required'],
            ...
            [['phone'], 'number'],
            [['phone'], 'integer'],
            [['phone'], 'compare', 'compareValue' => 10 ** 15, 'operator' => '<=', 'type' => 'number','message' => 'El valor máximo permitido es 15 dígitos para el Teléfono.'],
            [['name'], 'string', 'max' => 255],
